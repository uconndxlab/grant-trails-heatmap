        ...
        <v-expansion-panels multiple accordian>
            ...
            <v-expansion-panel :key="1">
                ...
                <v-expansion-panel-text id="result-description">
                    ...
                    <h4> Credit</h4>
                    <p>Grant Trails is an open source project available for universities to showcase their geographic grant distribution. Source code can be found on GitHub.</p>
